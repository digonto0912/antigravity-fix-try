...
export function seedData() {
  ...
  storage.saveCategories(cid, cats);

  // 10 Products
  const pids = Array.from({ length: 10 }, () => generateId());
  const products: Product[] = [
    { id: pids[0], clientId: cid, name: 'Classic T-Shirt', sku: 'CTS-1001', description: 'Comfortable cotton t-shirt perfect for everyday wear. Available in multiple colors and sizes.', category: 'Clothing', basePrice: 599, salePrice: 449, images: ['/placeholder-product.svg'], variants: [{ id: generateId(), type: 'Size', options: ['S','M','L','XL'] }, { id: generateId(), type: 'Color', options: ['White','Black','Navy'] }], inventory: 45, lowStockThreshold: 10, purchasePrice: 250, slug: 'classic-t-shirt', status: 'active', views: 120, addToCartCount: 35, purchaseCount: 18, location: 'Shelf A1', createdAt: daysAgo(30), updatedAt: now },
    { id: pids[1], clientId: cid, name: 'Blue Jeans', sku: 'BLJ-1002', description: 'Premium denim jeans with a modern slim fit. Durable and stylish for any occasion.', category: 'Clothing', basePrice: 1299, salePrice: 999, images: ['/placeholder-product.svg'], variants: [{ id: generateId(), type: 'Size', options: ['28','30','32','34','36'] }], inventory: 30, lowStockThreshold: 8, purchasePrice: 600, slug: 'blue-jeans', status: 'active', views: 95, addToCartCount: 28, purchaseCount: 15, location: 'Shelf A2', createdAt: daysAgo(28), updatedAt: now },
    { id: pids[2], clientId: cid, name: 'Running Shoes', sku: 'RNS-1003', description: 'Lightweight running shoes with superior cushioning. Perfect for daily runs and gym workouts.', category: 'Shoes', basePrice: 2499, salePrice: 1899, images: ['/placeholder-product.svg'], variants: [{ id: generateId(), type: 'Size', options: ['7','8','9','10','11'] }], inventory: 15, lowStockThreshold: 5, purchasePrice: 1200, slug: 'running-shoes', status: 'active', views: 200, addToCartCount: 45, purchaseCount: 22, location: 'Shelf B1', createdAt: daysAgo(25), updatedAt: now },
    { id: pids[3], clientId: cid, name: 'Leather Wallet', sku: 'LTW-1004', description: 'Genuine leather wallet with multiple card slots and coin pocket. Elegant and functional.', category: 'Accessories', basePrice: 799, images: ['/placeholder-product.svg'], variants: [{ id: generateId(), type: 'Color', options: ['Brown','Black'] }], inventory: 50, lowStockThreshold: 10, purchasePrice: 350, slug: 'leather-wallet', status: 'active', views: 80, addToCartCount: 20, purchaseCount: 12, location: 'Shelf C1', createdAt: daysAgo(20), updatedAt: now },
    { id: pids[4], clientId: cid, name: 'Summer Dress', sku: 'SMD-1005', description: 'Light and breezy summer dress with floral patterns. Perfect for casual outings.', category: 'Clothing', basePrice: 899, salePrice: 699, images: ['/placeholder-product.svg'], variants: [{ id: generateId(), type: 'Size', options: ['S','M','L'] }], inventory: 8, lowStockThreshold: 5, purchasePrice: 400, slug: 'summer-dress', status: 'active', views: 150, addToCartCount: 40, purchaseCount: 20, location: 'Shelf A3', createdAt: daysAgo(18), updatedAt: now },
    { id: pids[5], clientId: cid, name: 'Sports Watch', sku: 'SPW-1006', description: 'Water-resistant digital sports watch with multiple functions and backlight display.', category: 'Accessories', basePrice: 1599, salePrice: 1199, images: ['/placeholder-product.svg'], variants: [{ id: generateId(), type: 'Color', options: ['Black','Silver','Blue'] }], inventory: 3, lowStockThreshold: 5, purchasePrice: 700, slug: 'sports-watch', status: 'active', views: 180, addToCartCount: 50, purchaseCount: 25, location: 'Shelf C2', createdAt: daysAgo(15), updatedAt: now },
    { id: pids[6], clientId: cid, name: 'Canvas Backpack', sku: 'CNB-1007', description: 'Durable canvas backpack with laptop compartment. Ideal for students and travelers.', category: 'Accessories', basePrice: 999, images: ['/placeholder-product.svg'], variants: [{ id: generateId(), type: 'Color', options: ['Gray','Green','Blue'] }], inventory: 22, lowStockThreshold: 8, purchasePrice: 450, slug: 'canvas-backpack', status: 'active', views: 70, addToCartCount: 18, purchaseCount: 10, location: 'Shelf C3', createdAt: daysAgo(12), updatedAt: now },
    { id: pids[7], clientId: cid, name: 'Formal Shirt', sku: 'FMS-1008', description: 'Classic formal shirt with premium cotton fabric. Wrinkle-resistant and comfortable.', category: 'Clothing', basePrice: 999, salePrice: 799, images: ['/placeholder-product.svg'], variants: [{ id: generateId(), type: 'Size', options: ['S','M','L','XL'] }, { id: generateId(), type: 'Color', options: ['White','Light Blue','Pink'] }], inventory: 35, lowStockThreshold: 10, purchasePrice: 450, slug: 'formal-shirt', status: 'active', views: 60, addToCartCount: 15, purchaseCount: 8, location: 'Shelf A4', createdAt: daysAgo(10), updatedAt: now },
    { id: pids[8], clientId: cid, name: 'Wireless Earbuds', sku: 'WEB-1009', description: 'True wireless earbuds with noise cancellation and long battery life.', category: 'Electronics', basePrice: 1999, salePrice: 1499, images: ['/placeholder-product.svg'], variants: [{ id: generateId(), type: 'Color', options: ['Black','White'] }], inventory: 0, lowStockThreshold: 5, purchasePrice: 800, slug: 'wireless-earbuds', status: 'active', views: 250, addToCartCount: 60, purchaseCount: 30, location: 'Shelf D1', createdAt: daysAgo(8), updatedAt: now },
    { id: pids[9], clientId: cid, name: 'Sunglasses', sku: 'SNG-1010', description: 'UV-protected polarized sunglasses with lightweight frame. Stylish and protective.', category: 'Accessories', basePrice: 499, images: ['/placeholder-product.svg'], variants: [{ id: generateId(), type: 'Style', options: ['Aviator','Wayfarer','Round'] }], inventory: 40, lowStockThreshold: 10, purchasePrice: 200, slug: 'sunglasses', status: 'active', views: 90, addToCartCount: 22, purchaseCount: 14, location: 'Shelf C4', createdAt: daysAgo(5), updatedAt: now },
  ];
  storage.saveProducts(cid, products);
  ...
  storage.saveCustomers(cid, customers);
  ...
  storage.saveOrders(cid, orders);

  // 5 Leads
  const leads: Lead[] = [
    { id: generateId(), clientId: cid, sessionId: 'sess-001', name: 'Nadia Islam', phone: '01611111111', firstVisit: daysAgo(2), lastVisit: daysAgo(0), totalVisits: 5, pagesViewed: ['/', '/products', '/products/running-shoes', '/products/sports-watch', '/cart'], productsViewed: [pids[2], pids[5], pids[0]], timeOnSite: 1200, cartAbandoned: true, abandonedCartValue: 1899, abandonedCartItems: [{ productId: pids[2], productName: 'Running Shoes', quantity: 1, price: 1899 }], leadStatus: 'hot', tags: ['Ready to Buy'], sessionRecordings: [{ recordingId: generateId(), timestamp: daysAgo(0), duration: 300, events: [{ type: 'pageview', timestamp: daysAgo(0), data: { page: '/' } }, { type: 'click', timestamp: daysAgo(0), data: { element: 'Product Card' } }, { type: 'cart_add', timestamp: daysAgo(0), data: { product: 'Running Shoes' } }] }], createdAt: daysAgo(2), updatedAt: now },
    { id: generateId(), clientId: cid, sessionId: 'sess-002', name: 'Arif Rahman', phone: '01722222222', firstVisit: daysAgo(3), lastVisit: daysAgo(1), totalVisits: 4, pagesViewed: ['/', '/products', '/products/blue-jeans', '/products/formal-shirt'], productsViewed: [pids[1], pids[7]], timeOnSite: 900, cartAbandoned: true, abandonedCartValue: 999, abandonedCartItems: [{ productId: pids[1], productName: 'Blue Jeans', quantity: 1, price: 999 }], leadStatus: 'hot', tags: ['Price Negotiation'], sessionRecordings: [], createdAt: daysAgo(3), updatedAt: now },
  ...
  storage.saveMessages(cid, messages);

  // Auto Responses
  const autoResponses: AutoResponse[] = [
    { id: generateId(), clientId: cid, trigger: 'cod', response: 'Yes, we offer Cash on Delivery (COD) throughout Bangladesh. You pay when you receive the product!', isActive: true, timesUsed: 12, createdAt: now },
    { id: generateId(), clientId: cid, trigger: 'delivery time', response: 'Hi {customer_name}! Orders are typically delivered within 3-5 business days. Dhaka orders may arrive within 1-2 days.', isActive: true, timesUsed: 8, createdAt: now },
    { id: generateId(), clientId: cid, trigger: 'return', response: 'We accept returns within 7 days of delivery. The product must be unused and in original packaging. Contact us to initiate a return.', isActive: true, timesUsed: 5, createdAt: now },
    { id: generateId(), clientId: cid, trigger: 'size', response: 'Please let me know which product you are interested in and I will share the available sizes with you!', isActive: true, timesUsed: 15, createdAt: now },
  ];
  storage.saveAutoResponses(cid, autoResponses);

  // 2 Suppliers
  const supIds = [generateId(), generateId()];
  const suppliers: Supplier[] = [
    { id: supIds[0], clientId: cid, name: 'BD Textiles Ltd', contactPerson: 'Mr. Hasan', phone: '01911111111', email: 'bdtextiles@email.com', address: 'Mirpur DOHS, Dhaka', paymentTerms: 'Net 30 days', totalPurchases: 50000, totalPaid: 35000, outstandingDebt: 15000, suppliedProducts: [pids[0], pids[1], pids[4], pids[7]], payments: [{ id: generateId(), amount: 20000, date: daysAgo(20), method: 'bank_transfer', note: 'Partial payment' }, { id: generateId(), amount: 15000, date: daysAgo(5), method: 'bkash', note: 'Monthly payment' }], purchaseHistory: [{ id: generateId(), amount: 30000, date: daysAgo(30), note: 'Initial stock' }, { id: generateId(), amount: 20000, date: daysAgo(10), note: 'Restock' }], notes: 'Reliable supplier for clothing items', createdAt: daysAgo(60) },
  ...
  storage.saveSuppliers(cid, suppliers);
  ...
  const entries: AccountingEntry[] = [
    ...
    { id: generateId(), clientId: cid, type: 'expense', category: 'Advertising', amount: 2000, description: 'Facebook Ads - May Campaign', paymentMethod: 'bkash', date: daysAgo(10), createdAt: daysAgo(10) },
  ...
  storage.saveAccountingEntries(cid, entries);

  // Set storefront client ID
  storage.setCartClientId(cid);
}
