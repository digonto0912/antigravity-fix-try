    ...
    <div className="space-y-6">
      ...
      <Modal isOpen={showForm} onClose={()=>setShowForm(false)} title="Add Transaction" size="md">
        <div className="space-y-4">
          ...
          <div><label className="text-sm text-gray-600">Payment Method</label><select value={form.paymentMethod} onChange={e=>setForm({...form,paymentMethod:e.target.value as typeof form.paymentMethod})} className="w-full mt-1 px-3 py-2 border rounded-lg text-sm"><option value="cash">Cash</option><option value="bkash">bKash</option><option value="nagad">Nagad</option><option value="bank">Bank</option></select></div>
