    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4">
        <div className="flex flex-wrap gap-3">
          ...
          <select value={`${sortBy}-${sortDir}`} onChange={e => { const [s, d] = e.target.value.split('-'); setSortBy(s); setSortDir(d as 'asc' | 'desc'); }} className="px-3 py-2 border border-gray-300 rounded-lg text-sm">
